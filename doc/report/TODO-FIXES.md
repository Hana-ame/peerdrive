...
- [x] archive/TODO.txt 前端UX全部实现 ✅ (2026-04-29 深夜)
  - 左侧栏合集列表：搜索/时间排序/Tag筛选/搜索历史
  - Android式导航：点击合集→进入浏览→回退列表→点击文件选中
  - 合集名不显示SHA256："文件a, 文件b 等N个文件"
  - 新建文件夹修复 + 拖拽到文件夹 + 移动到按钮
  - 移除"提交""克隆并修改"(Fork)混淆按钮
