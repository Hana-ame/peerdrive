...
- **详细分析** → [SHA256SUM_LAYER.md](./SHA256SUM_LAYER.md)
...
- **实现细节** → [SHA256SUM_LAYER.md](./SHA256SUM_LAYER.md)
...
- **详细分析** → [ANON_COLLECTION_LAYER.md](./ANON_COLLECTION_LAYER.md)
...
- **实现逻辑** → [ANON_COLLECTION_LAYER.md](./ANON_COLLECTION_LAYER.md) | **数据结构** → [DB.md](./DB.md)
...
- **详细分析** → [UPLOAD_LAYER.md](./UPLOAD_LAYER.md)
...
- **注册分析** → [REGISTER_LAYER.md](./REGISTER_LAYER.md)
...
- **配置分析** → [internal/config/config.go](./internal/config/config.go)
...
## 9. 测试
- **注册/下载测试**：`bash test_register_download.sh`
- **上传测试**：`bash test_upload.sh`
- **匿名合集测试**：`bash test_anon_collection.sh`
