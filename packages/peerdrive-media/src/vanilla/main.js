...
//       })
//     
//     // 方式 2：Service Worker 拦截（推荐）
//     PeerMedia.registerSW({ peer: 'node-1', allow: ['https://example.com/'] })
//     // 之后 <img src="https://example.com/a.png"> 自动经 WebRTC 加载
//   </script>
import { client, DEFAULT_SIGNALING, registerSW } from '../core.js'
...
export { client, DEFAULT_SIGNALING, registerSW }

export default { load, mount, setupSW, client, DEFAULT_SIGNALING }