// IPFS Panel: CID pinning, pinned list, gateway status, and libp2p monitoring
...
export default function IPFSPanel() {
  ...
  }, [refresh, refreshPins, refreshGateways]);
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 text-xs text-gray-500">
            ...
            <button onClick={() => { refresh(); refreshPins(); refreshGateways(); }}
