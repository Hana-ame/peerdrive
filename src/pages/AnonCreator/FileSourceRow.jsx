...
export default function FileSourceRow({ file, onAdd, onDragStart }) {
  return (
    <div draggable onDragStart={onDragStart ? (e) => onDragStart(e, file) : undefined}
      ...
      <a href={api.getDownloadUrl(file.hash)} target="_blank" rel="noreferrer" className="text-lg">{fileIcon(file.mime_type)}</a>
      ...
      <button onClick={() => onAdd(file.hash, file.filename, file.mime_type, file.size)}
