      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
            ...
            <div className="text-3xl font-bold text-amber-400">{btStatus?.num_nodes ?? '-'}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] text-gray-500">{btStatus?.num_nodes ?? '-'} 节点</span>
            </div>
            {btStatus ? (
              <div className="space-y-2">
                <div className="grid grid-cols-2 gap-2 text-xs">
