    ...
    <div className="flex flex-col py-4 px-2 h-full">
      <div className="flex items-center justify-between mb-2 px-2">
        ...
        <a href="#" onClick={e => { e.preventDefault(); if (onDownload) onDownload(); }}
          className="text-xs text-brand-400 hover:underline ml-3 shrink-0">⬇ 下载 PDF</a>
      </div>
      {url ? (
        <iframe src={url + '#view=FitH'} className="flex-1 w-full rounded-lg border border-white/[0.06]" title="PDF Preview" />
      ) : (
